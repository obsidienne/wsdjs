defmodule Wsdjs.Charts.RankTest do
  ...
  defp rank_fixture_params(attrs \\ %{}) do
    ...
    {:ok, %Wsdjs.Charts.Top{} = top} = Wsdjs.Charts.create_top(%{due_date: Timex.now, user_id: user.id})
    {:ok, %Wsdjs.Musics.Song{} = song} = Wsdjs.Musics.create_song(%{title: "a", artist: "a", genre: "soul", url: "http://t.a.com", user_id: user.id})
