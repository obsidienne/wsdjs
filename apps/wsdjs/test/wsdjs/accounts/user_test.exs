defmodule Wsdjs.Accounts.UserTest do
  ...
  test "changeset with minimal valid attributes" do
    changeset = User.create_changeset(%User{}, @create_attrs)
    assert changeset.valid?
  end

  test "email is unique" do
    changeset = User.create_changeset(%User{}, %{email: "alice@example.com"})
  ...
  test "email must have a valid format" do
    changeset = User.create_changeset(%User{}, %{email: "bullshit"})
    assert "has invalid format" in errors_on(changeset).email
  end

  test "email can't be blank" do
    changeset = User.create_changeset(%User{}, %{email: nil})
