defmodule WsdjsApi.CloudinaryHelper do
  @moduledoc """
  ...
  def art_url(%Art{cld_id: cld_id, version: version}, resolution) when is_integer(resolution) do
    @cld_https <> "c_crop,g_custom/c_fit,f_auto,h_#{resolution},q_auto,w_#{resolution}/fl_immutable_cache/" <> "v#{version}/#{cld_id}.jpg"
  end
